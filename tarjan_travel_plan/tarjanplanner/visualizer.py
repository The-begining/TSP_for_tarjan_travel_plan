...
class Visualizer:
    ...
    def plot_graph(graph, tsp_path=None, title="Network Graph"):
        ...
        nx.draw(graph, pos, with_labels=True, node_size=700, font_size=9, edge_color='white')
        ...
        for node, coords in pos.items():
            mode = graph.nodes[node].get("mode", "N/A")
            plt.text(coords[0], coords[1] + 0.01, mode, color='green', fontsize=8)
